                ...
                {slides.map((slide, index) => (
                    <SwiperSlide key={index}>
                        <div className="relative group flex flex-col items-center justify-center">
                            <img src={slide.image} loading="eager" className="object-cover transition-all duration-200 rounded-[1.5rem] ease-in-out group-hover:brightness-[0.15] xs:max-w-[250%] mt-[1.25em]"/>
